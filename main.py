...
def get_student_courses(username):
    ...
    if student:
        return [course.course_name for course in student.enrolled_courses]
    return []
...
def course_selection_page():
    ...
    except (AuthenticationError, CourseSelectionError) as e:
        st.error(str(e))
...
def course_display_page():
    ...
    except (AuthenticationError, CourseDisplayError) as e:
        st.error(str(e))
